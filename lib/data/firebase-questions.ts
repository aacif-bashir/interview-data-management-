/**
 * Firestore implementation of all question data-access functions.
 * The exported API surface is identical to the original Mongoose version so
 * route handlers (`app/api/questions/**`) need zero changes.
 *
